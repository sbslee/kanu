...
class KANU:
    ...
    def config_chatgpt(self):
        ...
        self.temperature = tk.IntVar(self.container, value=0.5)
        ...
        b = tk.Button(self.container, text="Submit", command=lambda: self.deploy_agent("ChatGPT", e.get(), self.model.get(), self.temperature.get()))
