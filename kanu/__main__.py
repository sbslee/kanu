...
class KANU:
    ...
    def config_chatgpt(self):
        ...
        m.grid(row=6, column=0, columnspan=2)
        ...
        self.prompt.grid(row=10, column=0, columnspan=2, sticky="nsew")
